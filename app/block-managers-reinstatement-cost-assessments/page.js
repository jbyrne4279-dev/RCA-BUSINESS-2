...
export default function BlockManagersPage() {
  return (
    <main>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative rounded-3xl overflow-hidden h-80 md:h-96 lg:h-[500px]" style={{boxShadow:'0 0 0 1px rgba(124,58,237,0.2), 0 24px 64px rgba(124,58,237,0.1), 0 4px 16px rgba(0,0,0,0.4)'}}>
            ...
            <div className="absolute bottom-0 left-0 right-0 p-7">
              <p className="text-white/90 text-sm font-medium leading-snug">RICS-regulated figures across your entire managed portfolio.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* OBLIGATION */}
      <section className="py-16 md:py-20 px-6 md:px-10 border-t border-white/[0.06]" style={{ background: '#07070f' }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            {[
              ...
              <div key={n} className="stat-card p-6 text-center">
                <p className="text-3xl font-bold text-white leading-none mb-3">{n}</p>
      ...
      {/* SERVICES */}
      <section className="py-16 md:py-20 px-6 md:px-10 border-t border-white/[0.06]" style={{ background: '#0d0d1e' }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="ls-card rounded-2xl p-7 flex flex-col">
              <p className="text-xs text-white/50 uppercase tracking-wider font-semibold mb-2">24-hour turnaround</p>
              <h3 className="font-bold text-2xl text-white mb-6">Per-Block Assessment</h3>
              ...
              <Link href="/contact?service=desktop#contact-form" className="border border-white/[0.1] text-white/60 font-semibold text-sm px-5 py-3 rounded-xl text-center hover:border-[#7c3aed] hover:text-[#a78bfa] transition-colors block">
                Instruct Per-Block Assessment →
              </Link>
            </div>

            <div className="ls-card rounded-2xl p-7 flex flex-col">
              <p className="text-xs text-white/50 uppercase tracking-wider font-semibold mb-2">Single instruction</p>
              <h3 className="font-bold text-2xl text-white mb-6">Portfolio Assessment</h3>
              <ul className="space-y-3 flex-1 mb-7">
              ...
              <Link href="/contact#contact-form" className="border border-white/[0.1] text-white/60 font-semibold text-sm px-5 py-3 rounded-xl text-center hover:border-[#7c3aed] hover:text-[#a78bfa] transition-colors block">
                Request Portfolio Quote →
              </Link>
            </div>

            <div className="rounded-2xl p-7 flex flex-col relative" style={{background:'linear-gradient(135deg, rgba(124,58,237,0.25) 0%, rgba(91,33,182,0.18) 100%)', border:'1px solid rgba(124,58,237,0.35)', boxShadow:'0 0 40px rgba(124,58,237,0.15)'}}>
              ...
              <Link href="/contact?service=3year#contact-form" className="btn-shine text-sm px-5 py-3 rounded-xl text-center block">
      ...
      {/* EVERY REPORT */}
      <section className="py-16 md:py-20 px-6 md:px-10" style={{ background: '#030308' }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
