    ...
    <main>
      ...
      <section className="py-16 md:py-24 px-6 md:px-10 bg-white border-t border-[#e2e8f0]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-white border border-[#e2e8f0] rounded-2xl overflow-hidden" style={{boxShadow:'0 8px 32px rgba(10,181,168,0.10)'}}>
            ...
            <div className="p-7 flex flex-col gap-5">
              {[
                ...
                <div key={year} className="flex gap-4 items-start">
                  <div className="shrink-0 w-14 h-14 rounded-xl flex items-center justify-center text-xs font-bold text-white" style={{background:'linear-gradient(135deg, #0ab5a8 0%, #087f7a 100%)'}}>
                    {year}
                  </div>
                  <div>
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={title} className="flex gap-3 items-start">
                  <svg className="w-5 h-5 shrink-0 mt-0.5 text-[#0ab5a8]" viewBox="0 0 20 20" fill="currentColor">
      ...
      <section className="py-16 md:py-24 px-6 md:px-10 bg-white border-t border-[#e2e8f0]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-[#e2e8f0] rounded-2xl p-7 flex flex-col" style={{boxShadow:'0 4px 16px rgba(10,181,168,0.08)'}}>
              <div className="w-11 h-11 rounded-xl flex items-center justify-center mb-5" style={{background:'rgba(10,181,168,0.10)'}}>
                <svg className="w-5 h-5 text-[#0ab5a8]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              ...
              <Link href="/contact#contact-form" className="text-[#0ab5a8] text-sm font-semibold hover:underline">
            ...
            <div className="bg-white border border-[#e2e8f0] rounded-2xl p-7 flex flex-col" style={{boxShadow:'0 4px 16px rgba(10,181,168,0.08)'}}>
              ...
              <Link href="/contact?service=3year#contact-form" className="text-[#0ab5a8] text-sm font-semibold hover:underline">
            ...
            <div className="bg-white border border-[#e2e8f0] rounded-2xl p-7 flex flex-col" style={{boxShadow:'0 4px 16px rgba(10,181,168,0.08)'}}>
              ...
              <Link href="/contact?service=desktop#contact-form" className="text-[#0ab5a8] text-sm font-semibold hover:underline">
      ...
      <section className="py-16 md:py-24 px-6 md:px-10" style={{background:'linear-gradient(135deg, #0ab5a8 0%, #087f7a 100%)'}}>
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link href="/contact#contact-form" className="inline-flex items-center justify-center px-6 py-3 rounded-full text-sm font-semibold bg-white hover:bg-white/90 transition-colors" style={{color:'#087f7a'}}>
