        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="text-[#5f6368] text-base leading-relaxed">
              Your RCA establishes the correct Declared Value. The inflation provision above it is the insurer's job. Those are two separate things.
            </p>
          </div>
      ...
      <section className="bg-white py-16 md:py-20 px-6 md:px-10 border-t border-[#dadce0]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-[#5f6368] text-base leading-relaxed">
              The freeholder or RMC director who set the figure may face a negligence claim from leaseholders for any unrecovered loss. A specialist RCA is the only defensible basis for the declared value.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 divide-y divide-[#dadce0]">
            {[
              ...
              { title: 'Demolition, clearance and professional fees.', desc: 'Site clearance, party-wall shoring, architect (8–12%), structural engineer (2–4%) and quantity surveyor (2–3%) fees. Asbestos-bearing debris adds sharply to disposal costs — surveyors ask for the asbestos survey and fire risk assessment up front.' },
              { title: 'VAT where non-recoverable.', desc: 'Most freeholders cannot recover VAT. Demolition, professional fees and partial-damage repairs attract 20% VAT and must be in the DV. Mixed-use blocks are itemised — residential and commercial elements declared separately so each can be insured and recharged to leaseholders correctly.' },
            ].map(({ title, desc }) => (
      ...
      <section className="bg-white py-16 md:py-20 px-6 md:px-10 border-t border-[#dadce0]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#202124] leading-tight mb-5">
              Post-2024 reforms make a defensible RCA more important, not less.
            </h2>
            <p className="text-[#5f6368] text-base leading-relaxed mb-6">
          ...
          <div className="space-y-4 mt-4">
            {[
              ...
              { title: 'Tribunal exposure', desc: 'If insurance fails to meet lease requirements, leaseholders can take the matter to the First-tier Tribunal, which can compel proper cover or order reimbursement. An accurate RCA is the paper trail that makes a challenge fail before it starts.' },
              { title: 'The compliance tailwind', desc: 'A commissioned RCA from a qualified, independent surveyor is the kind of demonstrable, fair-value service that survives the new scrutiny — and positions the freeholder or agent as acting correctly.' },
            ].map(({ title, desc }) => (
