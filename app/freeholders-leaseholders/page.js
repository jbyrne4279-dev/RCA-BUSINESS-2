        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative rounded-3xl overflow-hidden h-80 md:h-96 lg:h-[500px]" style={{boxShadow:'0 0 0 1px rgba(124,58,237,0.2), 0 24px 64px rgba(124,58,237,0.1), 0 4px 16px rgba(0,0,0,0.4)'}}>
            ...
            <div className="absolute bottom-0 left-0 right-0 p-7">
              <p className="text-white/80 text-sm font-medium leading-snug">RICS-regulated assessments for freeholders, RMC directors and leaseholders across the UK.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-4 mt-4">
            {[
              ...
              <div key={label} className={`ls-card p-6 flex gap-4 items-start ${ok ? 'border-[#7c3aed]' : ''}`} style={ok ? { background: 'rgba(124,58,237,0.12)' } : {}}>
      ...
      <section className="py-16 md:py-20 px-6 md:px-10 border-t border-white/[0.06] border-b border-white/[0.06]" style={{ background: '#0d0d1e' }}>
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="ls-card p-8 flex flex-col rounded-2xl">
            <span className="inline-flex items-center text-xs font-semibold uppercase tracking-[0.08em] px-3 py-1 rounded-full mb-5 w-fit" style={{ background: 'rgba(124,58,237,0.12)', color: '#a78bfa' }}>For Freeholders, RMCs &amp; RTM Companies</span>
            <h2 className="text-2xl md:text-3xl font-bold text-white leading-tight mb-4">
              Discharge the lease obligation with a defensible figure.
            </h2>
            <p className="text-white/50 text-base leading-relaxed mb-4 flex-1">
          ...
          <div className="ls-card p-8 flex flex-col rounded-2xl" style={{ background: 'rgba(124,58,237,0.12)', borderColor: 'rgba(124,58,237,0.35)' }}>
            <span className="inline-flex items-center text-xs font-semibold uppercase tracking-[0.08em] px-3 py-1 rounded-full mb-5 w-fit" style={{ background: 'rgba(255,255,255,0.08)', color: '#a78bfa' }}>For Leaseholders</span>
            <h2 className="text-2xl md:text-3xl font-bold text-white leading-tight mb-4">
          ...
          <div className="grid grid-cols-1 gap-5">
            {[
              ...
              <div key={label} className="stat-card p-6">
                <p className="text-2xl font-bold text-white leading-none mb-3">{stat}</p>
      ...
      <section className="py-16 md:py-20 px-6 md:px-10 border-b border-white/[0.06]" style={{ background: 'linear-gradient(135deg, rgba(124,58,237,0.25) 0%, rgba(91,33,182,0.18) 100%)', border: '1px solid rgba(124,58,237,0.35)', boxShadow: '0 0 40px rgba(124,58,237,0.15)' }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-12">
            <Link href="/contact#contact-form" className="bg-white text-[#7c3aed] font-semibold text-sm px-6 py-3 rounded-md hover:bg-white/90 transition-colors inline-block">Check Your Declared Value</Link>
          </div>
        </div>
      </section>
