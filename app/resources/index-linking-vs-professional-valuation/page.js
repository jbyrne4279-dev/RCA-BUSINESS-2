      ...
      <section className="bg-white py-16 px-6 md:px-10">
        <div className="max-w-3xl mx-auto space-y-10 text-[#3c4043] text-base leading-relaxed">
          ...
          <div>
            ...
            <p>Index-linking is the practice of adjusting a building&rsquo;s sum insured each year by a percentage factor &mdash; usually derived from the insurer&rsquo;s own construction cost index or the BCIS All-In Tender Price Index. The intention is to ensure the sum insured keeps pace with build cost inflation between formal assessments.</p>
            <p className="mt-4">Most block buildings insurance policies apply index-linking automatically at renewal. It is a useful safeguard &mdash; but it is not a substitute for a RICS reinstatement cost assessment, and conflating the two creates a specific and significant liability for managing agents and freeholders.</p>
          </div>

          <div>
            <p className="text-xs font-semibold text-[#5f6368] uppercase tracking-[0.15em] mb-4">What Index-Linking Cannot Do</p>
            <p>Index-linking adjusts the existing sum insured by a percentage. It does not re-examine whether the underlying figure was correct to begin with. If the original reinstatement figure was based on a developer&rsquo;s estimate, an insurer calculator, or a RICS assessment carried out before significant construction cost inflation, index-linking will perpetuate the error &mdash; and compound it slightly each year.</p>
            <p className="mt-4">Index factors are also generic. They reflect average national or regional build cost movements. They do not account for the specific construction type, specification, location, or specialist features of your building. A timber-framed block in central London and a concrete-frame block in the East Midlands will receive the same index factor &mdash; even though their actual reinstatement cost movements may be entirely different.</p>
          ...
          <div>
            ...
            <p>RICS guidance notes on building reinstatement cost assessments are clear: a formal professional assessment should be carried out at least every three years. Annual index-linking may be applied in the intervening years &mdash; but as an interim measure between assessments, not as a permanent substitute for them.</p>
          </div>

          <div>
            <p className="text-xs font-semibold text-[#5f6368] uppercase tracking-[0.15em] mb-4">What This Means for You</p>
            <p>If you are a managing agent or freeholder responsible for arranging block buildings insurance, your obligation under most leases is to insure to &lsquo;full reinstatement cost.&rsquo; Relying on index-linking alone &mdash; without a periodic RICS assessment &mdash; leaves you exposed to the argument that you did not take reasonable steps to establish what full reinstatement cost actually is.</p>
