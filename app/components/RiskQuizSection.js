...
export default function RiskQuizSection() {
  return (
    <section className="py-20 md:py-32 px-6 md:px-10 border-t border-[#e2e8f0]" style={{ background: '#fbf0f2' }}>
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        <div className="max-w-lg">
          <span className="badge badge-blue mb-5">Free Risk Check</span>
          <h2 className="text-4xl md:text-5xl font-bold text-[#2b0b14] leading-[1.1] tracking-tight mb-6">
        ...
        <div className="bg-white rounded-[28px]" style={{ boxShadow: '0 24px 64px rgba(43,11,20,0.12)' }}>
