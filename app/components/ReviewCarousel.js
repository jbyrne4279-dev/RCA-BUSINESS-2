...
const StarRow = () => (
  <div className="flex gap-1 mb-4">
    {[...Array(5)].map((_, i) => (
      <svg key={i} className="w-4 h-4" viewBox="0 0 20 20" fill="#0ab5a8" xmlns="http://www.w3.org/2000/svg">
    ...
    <section className="py-14 md:py-20 px-6 md:px-10 border-t border-[#e2e8f0] bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <span className="inline-flex items-center bg-[rgba(10,181,168,0.08)] text-[#087f7a] border border-[rgba(10,181,168,0.2)] text-xs font-semibold uppercase tracking-[0.08em] px-3 py-1 rounded-full mb-4">
            Client Feedback
          </span>
