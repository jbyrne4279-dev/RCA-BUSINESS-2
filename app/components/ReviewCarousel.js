    ...
    <section className="py-14 md:py-20 px-6 md:px-10 border-t border-[#e2e8f0] bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {reviews.map(({ quote, name, role, reviewCount, avatar, fallback, fallbackBg }) => (
            <div key={name} className="card-hover bg-white border border-[#e2e8f0] rounded-2xl p-7 flex flex-col gap-4" style={{ boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
