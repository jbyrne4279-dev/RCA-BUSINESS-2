      ...
      <div className="py-8 px-6 md:px-10" style={{ background: 'linear-gradient(135deg, #7A1F3D 0%, #5C1730 100%)' }}>
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-5">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <Link href="/contact#contact-form" className="font-semibold text-sm px-5 py-2 rounded-md transition-colors" style={{background:'#F5B800', color:'#2b0b14'}}>Get a Quote</Link>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 gap-6 md:gap-10 mb-10">
          ...
          <div className="col-span-1 sm:col-span-2 md:col-span-2 space-y-4">
            <div className="flex items-center gap-3 step-reveal-item">
              <LogoSpin width={52} height={52} src="/stearling-rebuild-logo-white.webp" className="h-13 w-13 opacity-90" />
            ...
            <div className="flex items-center gap-3 pt-1">
              ...
              />
              <span className="text-white/40 text-xs">RICS Regulated Firm</span>
            </div>
          </div>
