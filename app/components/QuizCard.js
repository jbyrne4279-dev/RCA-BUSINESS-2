...
const PROPERTY_TYPES = [
  ...
  },
  {
    id: 'other',
    label: 'Other',
    icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><path d="M9.09 9a3 3 0 015.83 1c0 2-3 2-3 4" /><line x1="12" y1="17" x2="12.01" y2="17" /></svg>,
  },
]

const ROLES = [
  { id: 'homeowner', label: 'Homeowner' },
  { id: 'buyer', label: 'First-Time Buyer' },
  { id: 'agent', label: 'Managing Agent' },
  { id: 'freeholder', label: 'Freeholder' },
  { id: 'portfolio', label: 'Block Manager' },
