    ...
    <div className="relative">
      {showBack && (
        <button
          ...
          className="absolute -top-4 -left-4 md:-top-5 md:-left-5 z-20 w-10 h-10 rounded-full bg-white border border-[#e2e8f0] shadow-lg flex items-center justify-center text-[#64748b] hover:text-[#0057FF] hover:border-[#0057FF] transition-colors"
        >
