...
const ALL_PAGES = [
  ...
  { slug: '/managing-agents-insurance-valuations', title: 'Managing Agents', summary: 'Discharge your compliance obligation and protect your PI file with a defensible valuation.', img: '/surveyor-rebuild-cost-assessment-rics.png' },
  ...
  { slug: '/block-managers-rebuild-cost-assessments', title: 'Block Managers', summary: 'Consistent, compliant figures across every block you manage, on a rolling cycle.', img: '/AdobeStock_270155966.jpeg' },
  { slug: '/commercial-rebuild-costs', title: 'Commercial Property', summary: 'Offices, retail, industrial and mixed-use, with tenant fitout and plant captured correctly.', img: '/commercial-rebuild-cost-assessment.png' },
  { slug: '/portfolio-rebuild-assessments', title: 'Portfolio Assessments', summary: 'One instruction, individual reports per asset, and a consolidated summary schedule.', img: '/AdobeStock_1477785304.jpeg' },
]
