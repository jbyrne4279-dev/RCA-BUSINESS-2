      ...
      <section className="bg-[#f8f9fa] py-16 md:py-20 px-6 md:px-10 border-t border-[#dadce0]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-3">
            {[
              { title: 'Online calculators', sub: 'Cannot capture tenant fitout, specialist plant or complex services.', ok: false },
              { title: 'Index-linking alone', sub: 'Adjusts the figure but does not validate the base.', ok: false },
              { title: 'Old inherited valuations', sub: '35%+ cost rise since 2020 makes pre-pandemic figures inaccurate.', ok: false },
              { title: 'RICS-aligned RCA', sub: 'Documented, site-based where needed, accepted by every UK insurer.', ok: true },
            ].map(({ title, sub, ok }) => (
