...
export const metadata = {
  title: "What Is a Rebuild Cost Assessment? A Homeowner's Guide",
  description: 'A plain-English guide for homeowners: what a Rebuild Cost Assessment is, how it differs from market value and sum insured, and why it matters for your buildings insurance.',
  alternates: { canonical: '/what-is-a-rebuild-cost-assessment' },
  openGraph: {
    type: 'website',
    locale: 'en_GB',
    url: 'https://stearlingreinstatement.com/what-is-a-rebuild-cost-assessment',
    siteName: 'Stearling Reinstatement',
    title: "What Is a Rebuild Cost Assessment? A Homeowner's Guide",
    description: 'A plain-English guide for homeowners: what a Rebuild Cost Assessment is, and why it matters for your buildings insurance.',
    images: [{ url: '/rca-surveyor-site-visit.webp', width: 1200, height: 630, alt: 'RICS surveyor carrying out a Rebuild Cost Assessment' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: "What Is a Rebuild Cost Assessment? A Homeowner's Guide",
    description: 'A plain-English guide for homeowners to Rebuild Cost Assessments.',
    images: ['/rca-surveyor-site-visit.webp'],
  },
}

const faqItems = [
  { question: 'Is a Rebuild Cost Assessment the same as a survey I get when buying a house?', answer: "No. A homebuyer's survey (like a RICS Level 2 or 3 Homebuyer Report) checks the physical condition of a property. A Rebuild Cost Assessment only calculates one figure: how much it would cost to demolish and completely rebuild the property if it were destroyed. They're prepared for different purposes and often by different specialists." },
  { question: 'Who actually needs a Rebuild Cost Assessment?', answer: 'Anyone responsible for setting the buildings insurance sum insured on a property. Most commonly that means freeholders, leaseholders in a block, RMC/RTM directors, landlords and portfolio owners. Some insurers and mortgage lenders also ask for one directly, particularly for older, listed or non-standard properties.' },
  ...
  { question: 'How long does a Rebuild Cost Assessment stay valid?', answer: 'RICS guidance recommends a full reassessment at least every three years, with the figure index-linked (adjusted for construction cost inflation) annually in between.' },
]
    ...
    '@graph': [
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: "What Is a Rebuild Cost Assessment?", item: 'https://stearlingreinstatement.com/what-is-a-rebuild-cost-assessment' },
        ],
      },
      {
        '@type': 'Article',
        headline: "What Is a Rebuild Cost Assessment? A Homeowner's Guide",
        description: 'A plain-English guide for homeowners to Rebuild Cost Assessments.',
  ...
  return (
    <main>
      ...
      <GuideHero
        ...
        imageAlt="RICS surveyor carrying out a Rebuild Cost Assessment"
        ...
        secondaryHref="/rebuild-cost-vs-market-value"
      ...
      <GuideOverview
        ...
        highlights={[
          ...
          { icon: 'not_interested', title: 'Not Market Value', desc: "Rebuild cost excludes the land. It's what it costs to rebuild the structure, not what a buyer would pay for the whole property." },
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="rounded-2xl border-2 border-[#7A1F3D] bg-white p-6" style={{boxShadow:'0 8px 24px rgba(122,31,61,0.15)'}}>
              <p className="text-xs font-semibold text-[#7A1F3D] uppercase tracking-wide mb-2">Rebuild Cost</p>
              <p className="text-[#64748b] text-sm leading-relaxed">What it costs to demolish the damaged structure and rebuild it, excluding the land. This is what a Rebuild Cost Assessment produces, and it's what your insurance should be based on.</p>
            </div>
            <div className="rounded-2xl border border-[#e2e8f0] bg-white p-6" style={{boxShadow:'0 4px 16px rgba(122,31,61,0.08)'}}>
              <p className="text-xs font-semibold text-[#7A1F3D] uppercase tracking-wide mb-2">Sum Insured</p>
              <p className="text-[#64748b] text-sm leading-relaxed">The figure on your policy schedule. Usually this is the rebuild cost plus a buffer for inflation and unforeseen costs, set by you or your insurer.</p>
            </div>
          </div>
          <p className="text-[#64748b] text-base leading-relaxed mt-8">
            Land keeps its value even if a building is destroyed, which is why rebuild cost is so often lower than market value in expensive areas. That's also why insuring at market value wastes money on extra premium, while insuring below rebuild cost leaves you exposed. Read more in <Link href="/rebuild-cost-vs-market-value" className="text-[#7A1F3D] font-medium hover:underline">Rebuild Cost vs Market Value</Link>.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white py-16 sm:py-24 px-6 md:px-10 border-t border-[#e2e8f0]">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-[#64748b] text-base leading-relaxed mb-4">
            If your sum insured is lower than your true rebuild cost, most UK insurers apply what's called the "average clause" (also known as the condition of average). It reduces every claim payout, not just on total losses, in proportion to how underinsured you are.
          </p>
      ...
      <RelatedGuides currentSlug="/what-is-a-rebuild-cost-assessment" />

      <ContactSection heading="Get your Rebuild Cost Assessment." />
      <FaqSection description="Straightforward answers to the questions homeowners ask most about Rebuild Cost Assessments." items={faqItems} />
    </main>
  )
}
