          ...
          <div className="lg:col-span-8 divide-y divide-[#e2e8f0]">
            {[
              ...
              <div key={title} className="py-8 flex gap-6">
                ...
                <div>
                  <h3 className="font-semibold text-[#0d1b3e] text-sm">{title}</h3>
                </div>
              </div>
            ))}
          </div>
            ...
            {[
              ...
              <div key={title} className="brix-card">
                <div className="h-32 flex items-center justify-center" style={{background:'#e8f5f4'}}>
                  <svg className="w-9 h-9" fill="none" stroke="#94a3b8" strokeWidth="1.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0012 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75z" /></svg>
                </div>
                <div className="p-5">
