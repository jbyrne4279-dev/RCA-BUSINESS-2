...
export const metadata = {
  ...
  description: 'Listed properties can cost 20-50% more to rebuild than standard construction. Our specialist Rebuild Cost Assessment accounts for heritage materials and methods.',
...
const faqItems = [
  { question: 'Why do listed buildings need a specialist Rebuild Cost Assessment?', answer: 'Under the Planning (Listed Buildings and Conservation Areas) Act 1990, rebuild of a listed building must be carried out in original style and materials. Lime mortar, handmade brick, heritage contractors and conservation consents all carry significant premiums over standard construction costs. A standard Rebuild Cost Assessment or generic rebuild cost tool cannot capture these a specialist on-site assessment by a heritage-qualified surveyor is the only method that produces a defensible declared value.' },
  { question: 'Is a desktop Rebuild Cost Assessment appropriate for a listed building?', answer: 'No. A desktop Rebuild Cost Assessment applies standard BCIS construction rates and cannot account for specialist materials, heritage labour, conservation authority consent costs or the extended programme timescales that characterise a listed building rebuild. On-site inspection by a specialist surveyor is the only approach that produces a defensible rebuild cost assessment for a listed property.' },
  { question: 'Can Stearling Reinstatement assess Grade I and Grade II* listed buildings?', answer: 'Yes. We carry out on-site Rebuild Cost Assessments for all listed building categories Grade I, Grade II* and Grade II. Grade I and Grade II* buildings require physical inspection and specialist heritage knowledge that no desktop rebuild cost assessment can replicate. We confirm the programme and fee on receipt of your enquiry.' },
  { question: 'What is the VAT position on a listed building Rebuild Cost Assessment?', answer: 'A full rebuild after total loss is zero-rated for VAT purposes. However, demolition, professional fees and partial-damage repairs all attract 20% VAT. Since most real insurance claims are partial rather than total-loss, VAT at 20% applies to the majority of listed building insurance rebuild work and it is routinely excluded from desktop or non-specialist rebuild cost assessments.' },
  { question: 'How often should a listed building Rebuild Cost Assessment be updated?', answer: 'A full specialist Rebuild Cost Assessment is required at least every three years, with annual BCIS-indexed inflation reviews in between. Where material works have been carried out or where the building has not had a formal rebuild cost assessment since before 2020 a fresh site-based assessment should be commissioned before the next renewal date.' },
]
  ...
  return (
    <main>
      ...
      <GuideOverview
        ...
        description="Under the Planning (Listed Buildings and Conservation Areas) Act 1990, rebuild must replicate original style and materials - a legal obligation that generic desktop calculators systematically miss."
        highlights={[
            ...
            <div className="space-y-5">
              <div className="grade-card flex gap-4 items-start p-4 rounded-xl" style={{background:'rgba(122,31,61,0.06)'}}>
                ...
                <div>
                  ...
                  <p className="text-[#64748b] text-sm leading-relaxed">Highest significance - only 2% of listed buildings. Rebuild requires the most exacting materials match and Heritage England involvement.</p>
                </div>
              </div>
              <div className="grade-card flex gap-4 items-start p-4 rounded-xl" style={{background:'rgba(122,31,61,0.06)'}}>
                ...
                <div>
                  ...
                  <p className="text-[#64748b] text-sm leading-relaxed">Particularly important buildings - 6% of the list. Often require specialist heritage contractors and conservation officer input on every element of rebuild.</p>
                </div>
              </div>
              <div className="grade-card flex gap-4 items-start p-4 rounded-xl" style={{background:'rgba(122,31,61,0.06)'}}>
                <span className="font-bold text-[#7A1F3D] text-sm shrink-0 mt-0.5">II</span>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="space-y-5 mb-8 text-left">
            {[
              ...
              { title: 'Broker-ready report', body: 'The final report sets out the declared rebuild cost with a full methodology note, ready for submission to your insurer at renewal.', icon: <span className="text-xs font-bold text-white flex items-center justify-center w-full h-full">04</span> },
            ].map(({ title, body, icon }) => (
              <div
                key={title}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                desc: 'We price lime mortar, handmade brick, natural stone, historic timber and specialist period finishes - each at rates that reflect the actual cost of authentic rebuild.',
      ...
      <FaqSection description="Common questions about Rebuild Cost Assessments for listed and heritage buildings." items={faqItems} />
    </main>
  )
}
