        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative rounded-3xl overflow-hidden h-80 md:h-96 lg:h-[500px]" style={{boxShadow:'0 0 0 1px rgba(124,58,237,0.2), 0 24px 64px rgba(124,58,237,0.1), 0 4px 16px rgba(0,0,0,0.4)'}}>
            ...
            <div className="absolute bottom-0 left-0 right-0 p-7">
              <p className="text-white/80 text-sm font-medium leading-snug">Specialist reinstatement cost assessments for blocks of flats across the UK.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-4 mt-4">
            {[
              ...
              <div key={label} className={`ls-card p-6 flex gap-4 items-start ${ok ? 'border-white/[0.08]' : ''}`} style={ok ? {borderColor:'rgba(124,58,237,0.4)', background:'rgba(124,58,237,0.08)'} : {}}>
          ...
          <div className="grid grid-cols-1 gap-5">
            {[
              ...
              <div key={label} className="stat-card p-6 flex items-center gap-6">
                <p className="text-4xl font-bold text-white leading-none shrink-0 w-24">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { title: 'Portfolio instructions', desc: 'Multiple blocks assessed under a single instruction. Individual reports per property with a portfolio summary schedule and staggered scheduling.', href: '/portfolio-reinstatement-assessments' },
            ].map(({ title, desc, href }) => (
              <div key={title} className="brix-card">
                <div className="h-32 flex items-center justify-center" style={{background:'rgba(124,58,237,0.08)'}}>
                  <svg className="w-9 h-9" fill="none" stroke="rgba(167,139,250,0.4)" strokeWidth="1.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008z" /></svg>
                </div>
                <div className="p-5">
      ...
      <section className="py-16 md:py-20 px-6 md:px-10 border-b border-white/[0.06]" style={{ background: '#030308' }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-12">
            <Link href="/contact#contact-form" className="bg-white text-[#7c3aed] font-semibold text-sm px-6 py-3 rounded-md hover:bg-white/90 transition-colors inline-block">Book an Assessment</Link>
          </div>
        </div>
      </section>
