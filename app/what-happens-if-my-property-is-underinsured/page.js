        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl border border-[#e2e8f0] p-6 sm:p-8 space-y-5" style={{boxShadow:'0 8px 32px rgba(0,87,255,0.10)'}}>
            <p className="text-[#64748b] text-sm leading-relaxed">
              Your home's true reinstatement cost is <strong className="text-[#0d1b3e]">£400,000</strong>, but your policy's sum insured is only <strong className="text-[#0d1b3e]">£300,000</strong> — you're insured for 75% of what it would actually cost to rebuild.
            </p>
            <p className="text-[#64748b] text-sm leading-relaxed">
              A kitchen fire causes <strong className="text-[#0d1b3e]">£20,000</strong> of damage. You might expect your insurer to pay the full £20,000 since it's well within your sum insured. Under the average clause, they don't:
            </p>
            <div className="rounded-xl p-5" style={{background:'rgba(0,87,255,0.08)'}}>
              ...
              <p className="text-3xl font-bold text-[#0057FF] leading-none mt-2 mb-1">= £15,000</p>
              <p className="text-sm text-[#64748b]">paid out, not £20,000</p>
            </div>
            <p className="text-[#64748b] text-sm leading-relaxed">
              You're left to find the remaining <strong className="text-[#0d1b3e]">£5,000</strong> yourself, out of pocket, for a claim that was well within your policy limit. The 25% shortfall in your sum insured cost you 25% of every claim you'll ever make on that policy.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-16 sm:py-24 px-6 md:px-10 border-t border-[#e2e8f0]">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-[#64748b] text-base leading-relaxed">
            Not sure if this applies to you? Start with <Link href="/do-i-need-a-reinstatement-cost-assessment" className="text-[#0057FF] font-medium hover:underline">Do I Need a Reinstatement Cost Assessment?</Link> or see <Link href="/reinstatement-cost-assessment-cost" className="text-[#0057FF] font-medium hover:underline">what it costs to find out</Link>.
          </p>
        </div>
      </section>
