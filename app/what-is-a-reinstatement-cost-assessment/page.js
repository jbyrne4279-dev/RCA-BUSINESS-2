  ...
  return (
    <main>
      ...
      <GuideHero
        ...
        subtitle="In plain English: a professional calculation of what it would cost to completely demolish and rebuild your home from scratch — not what it's worth on the market, and not what you paid for it."
      ...
      <GuideOverview
        ...
        highlights={[
          { icon: 'verified', title: 'RICS-Regulated Figure', desc: 'Carried out by a chartered surveyor, using RICS professional standards - a figure insurers and brokers accept without challenge.' },
