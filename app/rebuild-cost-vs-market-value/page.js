...
export const metadata = {
  title: "Market Value vs Rebuild Cost: What's the Difference?",
  description: "Confusing what your home could sell for with what it would cost to rebuild is the most common reason UK homes are wrongly insured. See how a Rebuild Cost Assessment differs from market value.",
  alternates: { canonical: '/rebuild-cost-vs-market-value' },
  openGraph: {
    type: 'website',
    locale: 'en_GB',
    url: 'https://stearlingreinstatement.com/rebuild-cost-vs-market-value',
    siteName: 'Stearling Reinstatement',
    title: "Market Value vs Rebuild Cost: What's the Difference?",
    description: 'A clear, visual comparison of market value and rebuild cost, and why confusing the two with your Rebuild Cost Assessment figure leads to over- or under-insuring your home.',
    images: [{ url: '/rca-high-rise-residential.webp', width: 1200, height: 630, alt: 'Rebuild cost vs market value comparison' }],
  },
  twitter: {
    ...
    '@graph': [
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Rebuild Cost vs Market Value', item: 'https://stearlingreinstatement.com/rebuild-cost-vs-market-value' },
        ],
      },
    ],
  }
    ...
    <main>
      ...
      <GuideOverview
        ...
        highlights={[
          ...
          { icon: 'foundation', title: 'Rebuild Cost', desc: 'Answers "what would it cost to rebuild?" - driven by construction cost per m² and materials.' },
      ...
      <section className="py-16 sm:py-24 px-6 md:px-10 border-t border-[#e2e8f0]" style={{background:'rgba(122,31,61,0.08)'}}>
        <div className="max-w-4xl mx-auto">
          ...
          <ComparisonTable
            columns={['Market Value', 'Rebuild Cost']}
            rows={[
      ...
      <section className="bg-white py-16 sm:py-24 px-6 md:px-10 border-t border-[#e2e8f0]">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-[#64748b] text-base leading-relaxed">
            Insure below the true rebuild cost, and you're underinsured. That means any claim, not just a total loss, gets reduced under the insurer's average clause. See exactly how that works in <Link href="/what-happens-if-my-property-is-underinsured" className="text-[#7A1F3D] font-medium hover:underline">What Happens If My Property Is Underinsured?</Link>
          </p>
        </div>
      </section>
      ...
      <RelatedGuides currentSlug="/rebuild-cost-vs-market-value" />

      <ContactSection heading="Get an accurate rebuild figure for your home." />
      <FaqSection description="Common questions homeowners ask when comparing rebuild cost and market value." items={faqItems} />
    </main>
  )
}
