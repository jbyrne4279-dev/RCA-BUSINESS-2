...
const faqItems = [
  { question: 'Can managing agents be held liable for underinsurance?', answer: 'Yes. The managing agent carries a duty of care to leaseholders, and where a shortfall in cover arises from negligence or failure to review the valuation, the agent — not just the freeholder — may face a professional negligence or E&O claim. An underinsured block at claim stage is a textbook PI trigger. Commissioning a proper, RICS-aligned RCA on the recommended cycle is the defensible position.' },
  ...
  { question: 'What is the difference between Declared Value and Sum Insured?', answer: 'The Declared Value (DV) is the full reinstatement figure the RCA produces — the day-one rebuild cost the agent is responsible for establishing. The Sum Insured (SI) is set by the insurer and equals the DV plus an inflation provision, typically 20–50% uplift. A DV of £5m typically becomes an SI of around £6.5m. Agents who misread the higher SI as "over-insurance" push freeholders to under-declare, creating a real underinsurance gap at claim stage.' },
  { question: 'How does the FCA Consumer Duty affect managing agents?', answer: 'From January 2024, leaseholders are defined as customers and firms must act in their best interests, ensure fair value and disclose commission. The Leasehold and Freehold Reform Act 2024 moves to ban insurance commissions charged to leaseholders altogether. Every cost recharged via service charge must now be demonstrably justified. An independent RCA from a qualified surveyor is exactly that kind of transparent, value-adding work.' },
  ...
  { question: 'What do RTM companies need to know?', answer: 'When leaseholders exercise the Right to Manage, the obligation to arrange buildings insurance transfers with it. RTM companies should establish the correct declared value before the first renewal. A proper RCA from the outset creates a defensible file from day one and demonstrates compliance to leaseholders, who are now defined as customers under FCA rules.' },
]
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-4">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#202124] leading-tight mb-5">
              Five ways an inadequate RCA lands on the agent's file.
            </h2>
          ...
          <div className="lg:col-span-8 divide-y divide-[#dadce0]">
            {[
              ...
              { n: '05', title: 'LFRA commission ban.', desc: 'The Leasehold and Freehold Reform Act 2024 moves to ban insurance commissions charged to leaseholders altogether. Every cost recharged via service charge must now demonstrate real value. An independent RCA does that; a commission clip does not.' },
            ].map(({ n, title, desc }) => (
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-4">
            {[
              ...
              { label: 'Specialist RCA on the RICS cycle', desc: 'Full assessment every three years. Annual BCIS indexation between reassessments. Fresh instruction after material works. A defensible file at every stage.', ok: true },
            ].map(({ label, desc, ok }) => (
      ...
      <section className="bg-white py-16 md:py-20 px-6 md:px-10 border-t border-[#dadce0]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="text-[#5f6368] text-base leading-relaxed mb-6">
              The RCA must state the declared value, the assumptions applied, the review date and the scope of assessment in terms that brokers, insurers and leaseholders can rely on. For mixed-use blocks, the residential and commercial elements are itemised separately so each can be insured and recharged to the correct leaseholders.
            </p>
            <p className="text-[#5f6368] text-base leading-relaxed mb-8">
              A specialist surveyor will ask for the fire risk assessment and asbestos survey up front — asbestos-bearing debris materially increases disposal costs and must be accounted for in the DV.
            </p>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-white/80 text-base leading-relaxed mb-6">
              Managing agents place block policies across portfolios — the same logic applies to RCAs. We handle volume, itemise DVs building by building, phase assessments to smooth cost across service-charge years, and deliver standing three-year cycles with desktop reviews between. One instruction covering your whole book. No re-instructing annually. No administration overhead.
            </p>
            <p className="text-white/80 text-base leading-relaxed mb-8">
              We diarise the re-instruction triggers with you: an extension to a ground-floor flat nudges the DV upward; a new storey on top forces both a new RCA and a service-charge re-apportionment. We flag both before the renewal date.
            </p>
